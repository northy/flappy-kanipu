	...
	return A3(
		...
		A2(
			...
			A2(
				$elm$json$Json$Decode$field,
				'target',
				A2($elm$json$Json$Decode$field, info.aS, $elm$json$Json$Decode$bool))));
};
			...
			case 5:
				...
				return A3(
					...
					_Utils_update(
						computer,
						{
							aU: A3($evancz$elm_playground$Playground$mouseMove, x, y, computer.aU)
						}));
			case 6:
				return A3(
					$evancz$elm_playground$Playground$Game,
					...
					_Utils_update(
						computer,
						{
							aU: A2($evancz$elm_playground$Playground$mouseClick, true, computer.aU)
						}));
			case 7:
				var isDown = msg.a;
				return A3(
					...
					_Utils_update(
						computer,
						{
							aU: A2($evancz$elm_playground$Playground$mouseDown, isDown, computer.aU)
						}));
			default:
...
var $author$project$Main$permTable = $Herteby$simplex_noise$Simplex$permutationTableFromInt(42);
var $author$project$Main$noise = A2(
	$Herteby$simplex_noise$Simplex$fractal2d,
	{aZ: 20000.0, a0: 400.0, a2: 1.0, a3: 50},
	$author$project$Main$permTable);
var $author$project$Main$getNoise = function (x) {
	return A2($author$project$Main$noise, x * 123, x * 12);
};
var $author$project$Main$addPipes = F2(
	function (itc, pipes) {
		return ($elm$core$List$length(pipes) < 4) ? _Utils_ap(
			pipes,
			_List_fromArray(
				[
					A2(
					...
					2250,
					$author$project$Main$getNoise(itc) * 250)
				])) : pipes;
	});
...
var $author$project$Main$main = A3($evancz$elm_playground$Playground$game, $author$project$Main$view, $author$project$Main$update, $author$project$Main$init);
